...
\item Guess how to estimate $X$ from $Y$.\\
	\solution
	if the received signal is  is greater than 0, then the receiver assumes $s_1$ was transmitted.\\
if the received signal is  is less than or equal to 0, then the receiver assumes $s_0$ was transmitted, where $s_0$ and $s_1$ are cases of $X=1$and $X=-1$ respectively where threshold 0 is taken to be the decision boundary.
\begin{align}
y>0 \implies s_1\\
y\leq 0 \implies s_0
\end{align}
...
&p(e|s_1)=\frac{1}{\sqrt{2 \pi}} \int_{-\infty}^{0} e^{-\frac{(y-1)^{2}}{2}} dy\\
\nonumber
&=Q(1)\\
&p(e|s_0)=\frac{1}{\sqrt{2 \pi}} \int_{0}^{\infty} e^{-\frac{(y+1)^{2}}{2}} dy \\
\nonumer
&=Q(1)
\end{align}
%
...
\begin{align}
 ...
 &p(e|s_1)=\frac{1}{\sqrt{2 \pi}} \int_{-\infty}^{\delta} e^{-\frac{(y-1)^{2}}{2}} dy\\
 \nonumber
 &p(e|s_0)=\frac{1}{\sqrt{2 \pi}} \int_{\delta}^{\infty} e^{-\frac{(y+1)^{2}}{2}} dy\\
\nonumber
&P_e=\frac{1}{2\sqrt{2 \pi}}{( \int_{-\infty}^{\delta} e^{-\frac{(y-1)^{2}}{2}}dy+ \int_{\delta}^{\infty} e^{-\frac{(y+1)^{2}}{2}} dy)}\\
&P_e=\frac{Q(\delta+1)+Q(1-\delta)}{2}\\
&P_e=f(\delta)\\
&\text{to minimize} P_e, \frac{d(f(\delta))}{d\delta}=0 ~\text{and} f"(\delta)>0\\
&e^{\frac{-(1-\delta)^{2}}{2}}-e^{\frac{-(1+\delta)^{2}}{2}}=0\\
&\therefore 1-\delta=1+\delta, \implies \delta=0\\
&f"(\delta)=k((1-\delta)e^{\frac{-(1-\delta)^{2}}{2}}+(1+\delta)e^{\frac{-(1+\delta)^{2}}{2}})>0
\end{align}
...
\solution
 ...
 =p Q(1+\delta)+(1-p)Q(1-\delta)\\
 \frac{d(P_{e})}{d(\delta)}=0\\
 \implies e^\frac{(1+\delta)^{2}-(1-\delta)^{2}}{2}=\frac{p}{1-p}\\
 \therefore \delta=\frac{1}{2}log(\frac{p}{1-p})\\
  \frac{d(P_{e})}{d(\delta)}\quad at \quad \delta+\epsilon>0 \\
  \nonumber
   \frac{d(P_{e})}{d(\delta)} \quad at\quad \delta-\epsilon<0 \\
   \nonumber
   \therefore \delta=\frac{1}{2}log(\frac{p}{1-p})\longrightarrow minima
 \end{align}
 \\
